...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="en">
      <body>
        <WorkspaceProvider>
          <nav className="mx-auto flex w-full max-w-5xl flex-wrap items-center gap-4 px-6 py-4 text-sm text-zinc-300" aria-label="Primary navigation">
