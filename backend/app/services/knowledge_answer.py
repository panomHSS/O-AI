...
class KnowledgeAnswerService:
    ...
    def answer(self, question: str, conversation_id: UUID | None) -> KnowledgeAnswerResponse:
        ...
        if not context:
            ...
            answer = self._chat.send_message(self._prompt.build(intent.question, context, conflicts), history, memories)
