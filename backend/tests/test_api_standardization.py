...
class ApiStandardizationTests(unittest.TestCase):
    ...
    def test_chat_uses_success_envelope_with_override(self) -> None:
        ...
        self.assertEqual(status_code, 200)
        self.assertEqual(body, {"success": True, "data": {"reply": "Test reply: Hello", "conversation_id": "11111111-1111-1111-1111-111111111111", "memories_used": [], "reasoning_plan": None, "planning_plan": None, "decision_analysis": None}})
