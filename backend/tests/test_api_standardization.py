...
class ApiStandardizationTests(unittest.TestCase):
    ...
    def test_health_uses_success_envelope(self) -> None:
        ...
        self.assertEqual(body["data"]["database_revision"], "0006_project_update_proposals")
    ...
    def test_chat_uses_success_envelope_with_override(self) -> None:
        ...
        self.assertEqual(status_code, 200)
        self.assertEqual(body, {"success": True, "data": {"reply": "Test reply: Hello", "conversation_id": "11111111-1111-1111-1111-111111111111", "memories_used": [], "reasoning_plan": None, "planning_plan": None, "decision_analysis": None, "goal_analysis": None}})
